function showTime() { 
	...
	var startDate = new Date(2018, 12, 18);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear: SuLin<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >---LS   2019-03-08</c>"; 
